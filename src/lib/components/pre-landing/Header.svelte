              ...
              <NavigationMenuContent>
                ...
                >
                  <div class="row-span-3">
                    <NavigationMenuLink
                      href="#features"
                      class="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-blue-500 to-blue-600 p-6 no-underline outline-none focus:shadow-md"
                    >
                      ...
                      <p class="text-sm leading-tight text-blue-100">
                        Automatiza tu CRM con agentes inteligentes que trabajan
                        24/7
                      </p>
                    </NavigationMenuLink>
                  </div>
